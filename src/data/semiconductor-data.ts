...
export const wafer_sort_yield_summary = createDimension({
  ...
  ZONAL_ISSUES: createAttribute({
    name: 'ZONAL_ISSUES',
    type: 'numeric-attribute',
    expression: '[wafer_sort_yield_summary.ZONAL_ISSUES]',
  }),
...
export const Measures = {
  BIN_NUMBER: measureFactory.max(wafer_sort_bin_data.BIN_NUMBER),
};
