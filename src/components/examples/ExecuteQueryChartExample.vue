...
import ExecuteQueryChartSnippet from '../snippets/ExecuteQueryChartSnippet.vue';
...
const codeSnippet = useGetRawFile('/src/components/snippets/ExecuteQueryChartSnippet.vue');
</script>
  ...
  <article className="my-8 w-full" id="bar">
    <Header>
      <div className="flex flex-col mr-4 flex-1">
        <SubTitle id="bar">useExecuteQuery Hook</SubTitle>
        <Paragraph>
          useExecuteQuery hook allows you to run a query and access the results. <br />
