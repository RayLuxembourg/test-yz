...
import MemberFilterSnippet from '../snippets/MemberFilterSnippet.vue';
...
const codeSnippet = useGetRawFile('/src/components/snippets/MemberFilterSnippet.vue');
</script>
  ...
  <article className="my-8 w-full" id="date-range-filter">
    <Header>
      <div className="flex flex-col mr-4 flex-1">
        <SubTitle id="date-range-filter">Member Filter</SubTitle>
      </div>
      <ButtonGroup
