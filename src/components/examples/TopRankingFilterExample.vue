...
import TopRankingFilterSnippet from '../snippets/TopRankingFilterSnippet.vue';
...
const codeSnippet = useGetRawFile('/src/components/snippets/TopRankingFilterSnippet.vue');
</script>

<template>
  <article className="my-8 w-full" id="date-range-filter">
    <Header>
      <div className="flex flex-col mr-4 flex-1">
        <SubTitle id="date-range-filter">Top Ranking Filter</SubTitle>
      </div>
      <ButtonGroup
